import './BarChartForm.css';


const BarChartForm = ({ formData, setFormData }) => {
    ...
    const borderColorCahngeHandler = (e) => {
        const value = e.target.value;
        const id = e.target.id;
        formData.borderColor.splice(id, 1, value);
        const updatedFormData = {
            ...formData,
        }
        setFormData(updatedFormData);
    ...
    return (
        <form>
            ...
            <div className='formContainer'>
                ...
                <br />
                <div className='dataAndLabelsContainer'>
                ...
                <br />
                <div className="colorsBarContainer">
                    ...
                    <div className="border">
                        ...
                        <h4>Border Colors:</h4>
                        {
                            formData.borderColor.map((item, index) =>
                                <div key={index}>
                                    <span> {+index + 1}: </span>
                                    <input id={index} type={`color`} value={item} onChange={borderColorCahngeHandler} />
                                </div>
                            )
                        }
